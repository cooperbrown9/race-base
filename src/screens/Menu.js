...
const options = [
  ...
  {name: 'Resource Maps', iconPath: require('../../assets/icons/navigation/flag.png'), path: NavActions.GO_RESOURCE_MAPS},
  {name: 'Weather', iconPath: require('../../assets/icons/navigation/weather.png'), path: NavActions.GO_FORECAST},
  {name: 'Race Map', iconPath: require('../../assets/icons/navigation/maps.png'), path: NavActions.GO_RACEMAP},
